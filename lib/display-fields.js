...
// Every DISPLAY_FIELDS key belongs to exactly one group.
const FIELD_GROUPS = [
  { id: 'quota', fields: ['plan', '5h', 'mcp', 'day', '30d'] },
  { id: 'session', fields: ['context', 'effort', 'session', 'speed'] },
  { id: 'model', fields: ['model'] },
];
